...
\newcommand{\dsharp}{%
  \mathrel{\stackon[0.2ex]{\sharp}{\rule{0.9ex}{0.08ex}}}%
}

\newcommand{\GLs}{\texttt{GL\textsubscript{s}}}
\newcommand{\RGL}{\texttt{RGL}}
\newcommand{\GL}{\texttt{GL}}
\newcommand{\FLC}{\texttt{FLC}}
\newcommand{\rlGL}{\texttt{rlGL}}
\newcommand{\Lmu}{\texttt{L}_\mu}
\newcommand{\Lstar}{\texttt{L}_*}
\newcommand{\N}{\mathcal N}
\newcommand{\W}{\mathcal W}
\newcommand{\C}{\mathcal C}
\newcommand{\DRec}{\raisebox{\depth}{\rotatebox{180}{\textbf{r}}}}
\newcommand{\DTest}{\raisebox{\depth}{\rotatebox{180}{\text{?}}}}
\newcommand{\Test}{\text{?}}
\newcommand{\Rec}{\textbf{r}}
\newcommand{\Dual}[1]{#1^\text{d}}
\newcommand{\sabodual}[1]{#1^\text{D}}
\newcommand{\sabocomp}[1]{#1^\text{C}}
\newcommand{\comp}[1]{#1^\text{c}}
\newcommand{\FRgm}[1]{#1^{\dagger}}
\newcommand{\FRfml}[1]{#1^{\sharp}}
\newcommand{\RF}[1]{#1^{\flat}}
\newcommand{\rlL}[1]{#1^{\reflectbox{$\flat$}}}
\newcommand{\GLsrl}[2]{#2^{#1}}
